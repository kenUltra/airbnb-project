...
export async function getHeaderData(){
    const action = await fetch("http://localhost:3000/Data/Place.json");
    const head = await action.json();
    const icons = head.Header;
    return icons;
}
export async function textHeader(){
    const main = await fetch("http://localhost:3000/Data/Place.json");
...
export async function Languages(){
    const leng = await fetch("http://localhost:3000/Data/language.json");
